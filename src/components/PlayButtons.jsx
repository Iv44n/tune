export const Play = () => {
    return (
        <svg width={34} height={36.5} viewBox="0 0 20.00 24.00" fill="none">
            <path
                d="M5 5V19M16 5V19"
                stroke="#000000"
                strokeWidth="1.2"
...
export const Pause = () => {
    return (
        <svg width={34} height={33} viewBox="0 0 21.00 24.00" fill="none">
            <path
...
export const PlayTrackPrev = () => {
    return (
        <svg width={26} height={30} viewBox="0 0 21.00 24.00" fill="none">
            <path
...
export const PlayTrackNext = () => {
    return (
        <svg width={26} height={30} viewBox="3 0 21.00 24" fill="none">
            <path
...
export function Loading() {
    return (
        <svg
            className="w-[33px] h-[33px] text-gray-100 animate-spin fill-blue-600"
            viewBox="0 0 100 101"
            fill="none"
        >
            <path
